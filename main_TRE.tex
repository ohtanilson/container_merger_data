...
\begin{abstract}
We create a comprehensive list of mergers within the global container shipping industry from 1966 (the industry's inception) to 2022. Combining this list with proprietary data, we employ a structural matching model (Fox 2018) to elucidate the historical shift in the significance of a firm's age, size, and geographical proximity in merger decisions.
Our findings indicate that, as a positive factor, a firm's size outweighs its age by a factor of seven to nine as a merger incentive between 1991 and 2005. Conversely, between 2006 and 2022, a firm's size surpasses its age by a factor of 1.4, functioning as a disincentive.
Furthermore, we observe that the distance between buyer and seller firms serves as a disincentive throughout the entire period, albeit its importance has dwindled to virtually zero in recent years.
In counterfactual simulations, we uncover that the prohibition of mergers between firms within the same country impacts not only the configuration of prohibited mergers but also those permitted.
\end{abstract} 
...
Container shipping plays a pivotal role in global trade, revolutionizing the world. According to data from IHS Markit and Descartes Datamyne, it constituted 45.4\% of amount-based imports to the U.S., 21.3\% of amount-based exports from the U.S., and 10.12\% of quantity-based world trade in 2021.
...
The merger pattern provides crucial insights into the global container shipping industry merger waves.
However, multiple factors could account for this pattern. 
For instance, recent acquisitions may prioritize a firm's size to expand market tonnage shares, unlike the period from 1966 to 1990. Alternatively, companies may emphasize geographical proximity to establish dominance at the local level.
To untangle these explanations and gain more precise insights into various channels, we employ a structural model that quantifies the relative significance of a firm's age, size, and geographical proximity using a novel approach — the matching maximum score estimator \cite{fox2018qe}.
...
During 1991-2005, a firm's size supersedes its age by a factor of seven to nine, serving as a merger incentive.
Conversely, between 2006 and 2022, a firm's size surpasses its age by 1.4 times, acting as a merger disincentive.
Additionally, we observe that geographical distance acts as a merger disincentive throughout the entire period, albeit its relative importance compared to a firm's age has dwindled to economic insignificance in recent years. 
...
In our counterfactual simulations, we discover that prohibiting mergers between firms in the same country affects not only the merger outcomes of the involved firms but also those engaged in permitted mergers. This foretells the ripple effect of local competition policies, influencing both local markets and the global market configuration.
...
First, Merger waves emerged post the enactment of the Shipping Act of 1984, signaling a shift from collusive behaviors.
...
Second, as an interesting finding, only 26.7\% of the counterfactual merger pairs are the same as actual pairs.
