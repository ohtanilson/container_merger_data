...
\begin{table}[!htbp]
  \begin{center}
      ...
      \input{figuretable/number_of_mergers_counterfactual_}
  \end{center}\footnotesize
...
% Note that the benchmark configurations based on an equilibrium matching which is stronger than pairwise stability matching provide just one of the potential pairwise stability matchings.
