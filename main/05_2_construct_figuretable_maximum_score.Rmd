  ...
  function(
    ...
    matching_number_IHS <-
      paste(
        "[",
        format(round(
          min(matching_pair_year_IHS_predicted),
          digits = 3), nsmall = 3),
        ",",
        format(round(
          max(matching_pair_year_IHS_predicted),
          digits = 3), nsmall = 3),
        "]",
        sep = ""
      )
    ...
    matching_number_HB <-
      paste(
        "[",
        format(round(
          min(matching_pair_year_HB_predicted),
          digits = 3), nsmall = 3),
        ",",
        format(round(
          max(matching_pair_year_HB_predicted),
          digits = 3), nsmall = 3),
        "]",
        sep = ""
      )
    ...
    result_for_output <-
      rbind(
        ...
        #   length(matching_pair_year_HB_counterfactual$matching_lat)),
        c(
          "\\% total match (counterfactual/data)",
          "",  
          rate_number_of_merger_IHS ,
          rate_number_of_merger_HB
          ),
        #c("","","",""),
        c(
          "\\% same match (counterfactual/data)",
          "",  
          rate_number_of_same_merger_HB, 
          rate_number_of_same_merger_HB
          )
